            ...
            <form action="" className="form-left">
              ...
              <div className="input-wrapper">
                ...
                <div className="icon-wrapper">
                    <IoPersonOutline name="person-outline" aria-hidden="true"/>
                  ...
                  <select name="person" className="input-field">
                    ...
                    <FaChevronDown name="chevron-down" aria-hidden="true"/>
                </div>

                <div className="icon-wrapper">
                    <IoCalendarClearOutline name="calendar-clear-outline" aria-hidden="true"/>
                ...
                <div className="icon-wrapper">
                    <IoTimeOutline name="time-outline" aria-hidden="true"/>
