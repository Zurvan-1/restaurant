    ...
    return (
        <section className="section menu" aria-label="menu-label" id="menu">
            <div className="container">
                ...
                <ul className="grid-list">
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-1.png" style={{width: 100, height: 100}} loading="lazy" alt="Greek Salad"
                                    className="img-cover" />
                            </figure>
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-2.png" style={{width: 100, height: 100}} loading="lazy" alt="Lasagne"
                                    className="img-cover" />
                            </figure>
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-3.png" style={{width: 100, height: 100}} loading="lazy" alt="Butternut Pumpkin"
                                    className="img-cover" />
                            </figure>
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-4.png" style={{width: 100, height: 100}} loading="lazy" alt="Tokusen Wagyu"
                                    className="img-cover" />
                            </figure>
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-5.png" style={{width: 100, height: 100}} loading="lazy" alt="Olivas Rellenas"
                                    className="img-cover" />
                            </figure>
                    ...
                    <li>
                        <div className="menu-card hover:card">
                            ...
                            <figure className="card-banner img-holder" style={{width: 100, height: 100}}>
                                <img src="assets/images/menu-6.png" style={{width: 100, height: 100}} loading="lazy" alt="Opu Fish"
                                    className="img-cover" />
                            </figure>
                ...
                <img src="assets/images/shape-5.png" style={{width: 921, height: 1036}} loading="lazy" alt="shape"
                    className="shape shape-2 move-anim" />
                <img src="assets/images/shape-6.png" style={{width: 343, height: 345}} loading="lazy" alt="shape"
